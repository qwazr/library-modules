...
public class PptParser implements ParserFactory, ParserInterface, PoiExtractor {

    private final static String NAME = "ppt";

    private static final MediaType DEFAULT_MIMETYPE = MediaType.valueOf("application/vnd.ms-powerpoint");

    private static final Collection<MediaType> DEFAULT_MIMETYPES = List.of(DEFAULT_MIMETYPE);

    private static final Collection<String> DEFAULT_EXTENSIONS = List.of("ppt");
