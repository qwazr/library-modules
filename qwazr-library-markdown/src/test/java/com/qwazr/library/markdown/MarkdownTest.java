...
public class MarkdownTest extends AbstractLibraryTest {
	...
	final static String TABLE_MD_PATH = "src/test/resources/com/qwazr/library/markdown/table.md";
	...
	public void convertResource() throws IOException {
		...
		Assert.assertNotNull(markdownDefaultTool.resourceToHtml("com/qwazr/library/markdown/table.md"));
	}
	...
	@Test
	public void builder() {
		MarkdownToolBuilder builder = MarkdownTool.of();
		Assert.assertNotNull(builder);
		MarkdownTool tool = builder.extension(MarkdownExtensionEnum.autolinks)
				.attributeProviderClass(BoostrapAttributeProvider.class)
				.build();
